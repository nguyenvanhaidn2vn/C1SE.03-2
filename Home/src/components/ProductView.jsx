...
const ProductView = props => {
    ...
    const [previewImg, setPreviewImg] = useState(API_URL + product.image)
    ...
    useEffect(() => {
        setPreviewImg(API_URL + product.image)
        setQuantity(1)
        setColor(undefined)
        setSize(undefined)
    }, [product])
        ...
        <div className="product">
            <div className="product__images">
                <div className="product__images__list">
                    <div className="product__images__list__item" onClick={() => setPreviewImg(API_URL + product.image)}>
